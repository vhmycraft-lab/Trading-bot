...
**Spec version:** 1.2 (2026-09-06) · **Companion documents:** `QuantLab_Implementation_Plan.md` (rationale), `docs/EVOLUTION.md` (evolutionary optimiser rationale, non-normative), `docs/ENVIRONMENT.md` (hidden randomised training environments, non-normative). This file is normative; where any two disagree, this file wins.
